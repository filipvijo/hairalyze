              ...
              <div className="border-l-4 border-pink-500 pl-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-pink-50 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 text-sm">Fine, thin hair with loose, barely-there waves. Easy to straighten and style but prone to becoming flat.</p>
                  </div>
                  <div className="bg-pink-50 p-4 rounded-lg">
              ...
              <div className="border-l-4 border-green-500 pl-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 text-sm">Less defined curl pattern with sharp angles and Z-shaped bends. Requires heavy moisturizing and protective styling.</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">Tight Coils</h4>
                    <p className="text-gray-700 text-sm">Tightest curl pattern with minimal visible curl definition. Extremely fragile and requires gentle, moisture-intensive care.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-gray-700 text-sm">Individual strands are thin and delicate. Often feels silky but can appear limp and lack volume.</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-4">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-gray-700 text-sm">Fewer hair follicles per square inch. Scalp may be visible, especially when hair is wet.</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-4">
          ...
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-700 mb-4">Our AI analyzes thousands of hair characteristics that the human eye might miss, providing more accurate results than self-assessment.</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-6">
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-700 text-sm">Our AI analyzes over 50 hair characteristics with 95% accuracy, often detecting subtle details that even professionals might miss during a quick consultation.</p>
            </div>
